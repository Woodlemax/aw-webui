export default {
  ...
  pomodoro: {
    title: 'Pomodoro',
    subtitle: 'Stay with the categories you chose while ActivityWatch keeps the timer running.',
    service: {
      connected: 'Background service connected',
      disconnected: 'Background service unavailable',
      unavailableTitle: 'Pomodoro service is not running',
      unavailableBody:
        'Start ActivityWatch with aw-notify enabled, then try again. An active timer lives in the background service, not in this page.',
      retry: 'Try again',
      unknownError: 'Something went wrong while communicating with the Pomodoro service.',
    },
    monitoring: {
      title: 'Activity monitoring is unavailable',
      body: 'The timer was paused for safety. Wait for ActivityWatch to recover, then resume it manually.',
    },
    afk: {
      title: 'Paused while you are away',
      body: 'Come back to the computer, then resume the timer manually.',
    },
    timer: {
      progress: 'Focus interval',
      remaining: 'remaining',
      paused: 'paused',
      pausedAfk: 'paused while away',
    ...
    state: {
      ...
      paused_afk: 'Away',
      waiting_confirmation: 'Next phase ready',
      completed: 'Completed',
    ...
    actions: {
      ...
      pause: 'Pause',
      resume: 'Resume',
      continue: 'Continue focusing',
      stop: 'Stop',
      stopConfirm: 'Stop this Pomodoro session? It will be saved as interrupted.',
      startNext: 'Start {phase}',
      saveDefaults: 'Save defaults',
    },
    focus: {
      title: 'Focus categories',
      currentCategory: 'Current category',
      selectedCategories: 'Selected for this session',
      uncategorized: 'Uncategorized',
    },
    distraction: {
      warningTitle: 'The timer is still running',
      warningBody:
        'You have been outside the selected categories for {timeout} seconds. Continue, pause, or stop the session.',
      activeTitle: 'Outside the selected categories',
      activeBody: 'Distraction time: {elapsed}. Returning before the timeout cancels the warning.',
    },
    confirmation: {
      title: 'The next phase waits for your confirmation',
      body: '{phase} will begin only when you start it.',
    },
    categories: {
      title: 'Choose focus categories',
      help: 'You may select several categories. A selected parent includes every nested category.',
      selected: '{count} selected',
      empty: 'No Categorization categories are available. Add them in Settings first.',
      toggleChildren: 'Show or hide nested categories',
      includesChildren: 'includes nested',
    },
    settings: {
      title: 'Session settings',
      help: 'These values are saved and prefilled the next time you open Pomodoro.',
      focusMinutes: 'Focus, minutes',
      shortBreakMinutes: 'Short break, minutes',
      longBreakMinutes: 'Long break, minutes',
      workIntervals: 'Focus intervals',
      distractionTimeoutSeconds: 'Distraction timeout, seconds',
      notifications: 'Notifications and sound',
      systemNotifications: 'Windows system notifications',
      chromeNotifications: 'Chrome notifications',
      sound: 'Sound',
    },
    validation: {
      categories: 'Select at least one focus category to start.',
      settings: 'Durations must be positive, and interval counts must be positive whole numbers.',
    },
    start: {
      readyTitle: 'Ready for a focused session?',
      readyBody: 'The timer will keep running even if you close this page or Chrome.',
    },
    duration: {
      hours: '{count} h',
      minutes: '{count} min',
    ...
    history: {
      ...
      subtitle: 'Completed and interrupted sessions saved by ActivityWatch.',
      empty: 'No Pomodoro sessions have been saved yet.',
      intervals: 'focus intervals',
      focusTime: 'Focus time',
      focusScore: 'Focus score',
      distractions: 'Distractions',
      distractedTime: 'Distracted time',
      ...
      reason: {
        ...
        activitywatch_restart: 'ActivityWatch restarted',
        server_error: 'Background service error',
      },
    },
  },
  stopwatch: {
